...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c36 = function(v) {return Res({group:"opr",r:v,type:"_-",eval:mode=="parse"?(-v.eval):null},`-${v}`,mode=="eval"?(-v):null)},
      peg$c37 = "\u221A",
      peg$c38 = peg$literalExpectation("\u221A", false),
      peg$c39 = function(v) {return Res({group:"opr",r:v,type:"_√",eval:mode=="parse"?(Math.sqrt(v.eval)):null},`(Math.sqrt(${v}))`,mode=="eval"?(Math.sqrt(v)):null)},
      peg$c40 = "^",
      peg$c41 = peg$literalExpectation("^", false),
      peg$c42 = function(l, r) {return Res({group:"opr",l:l,r:r,type:"^",eval:mode=="parse"?(l.eval**r.eval):null},`(${l}**${r})`,mode=="eval"?(l**r):null)},
      peg$c43 = "*",
      ...
      peg$c48 = function(r, c) {return (l)=>{return c(Res({group:"opr",l:l,r:r,type:"/",eval:mode=="parse"?(l.eval/r.eval):null},`${l}/${r}`,mode=="eval"?(l/r):null))}},
      peg$c49 = "%",
      ...
      peg$c52 = function(r, c) {return (l)=>{return c(Res({group:"opr",l:l,r:r,type:"+",eval:mode=="parse"?(l.eval+r.eval):null},`${l}+${r}`,mode=="eval"?(l+r):null))}},
      peg$c53 = function(r, c) {return (l)=>{return c(Res({group:"opr",l:l,r:r,type:"-",eval:mode=="parse"?(l.eval-r.eval):null},`${l}-${r}`,mode=="eval"?(l-r):null))}},
      peg$c54 = "<",
      peg$c55 = peg$literalExpectation("<", false),
      peg$c56 = function(r, c) {return (l)=>{return c(Res({group:"opr",l:l,r:r,type:"<",eval:mode=="parse"?((l.eval)<(r.eval)):null},`(${l})<(${r})`,mode=="eval"?((l)<(r)):null))}},
      ...
      peg$c72 = function(r, c) {return (l)=>{return c(Res({group:"opr",l:l,r:r,type:"==",eval:mode=="parse"?((l.eval)===(r.eval)):null},`(${l})===(${r})`,mode=="eval"?((l)===(r)):null))}},
      peg$c73 = "!==",
      peg$c74 = peg$literalExpectation("!==", false),
      peg$c75 = function(r, c) {return (l)=>{return c(Res({group:"opr",l:l,r:r,type:"!==",eval:mode=="parse"?((l.eval)!==(r.eval)):null},`(${l})!==(${r})`,mode=="eval"?((l)!==(r)):null))}},
      peg$c76 = " ",
      peg$c77 = peg$literalExpectation(" ", false),
      peg$c78 = function(v) {return v},
      peg$c79 = /^[0-9]/,
      peg$c80 = peg$classExpectation([["0", "9"]], false, false),
      peg$c81 = ".",
      peg$c82 = peg$literalExpectation(".", false),
      peg$c83 = function(int, dec) {
              let ret = int.join("")+"."+dec.join("")
              return Res({group:"literal",type:"num",value:ret,eval:Number(ret)},ret,Number(ret))
          },
      peg$c84 = function(int) { return Res({group:"literal",type:"num",value:int.join(""),eval:Number(int.join(""))},int.join(""),Number(int.join(""))) },
      peg$c85 = "true",
      peg$c86 = peg$literalExpectation("true", false),
      peg$c87 = function() {return Res({group:"literal",type:"bool",value:"true",eval:true},`true`,true)},
      peg$c88 = function() {return Res({group:"literal",type:"bool",value:"false",eval:true},`false`,false)},
      peg$c89 = "\"",
      peg$c90 = peg$literalExpectation("\"", false),
      peg$c91 = /^[a-zA-Z]/,
      peg$c92 = peg$classExpectation([["a", "z"], ["A", "Z"]], false, false),
      peg$c93 = function(content) {return Res({group:"literal",type:"str",value:content.join(""),eval:content.join("")},`'${content.join("")}'`,content.join(""))},
      ...
      peg$c95 = function(content) {let ret = content.join("");return Res({group:"name",value:ret,eval:ret},`"${ret}"`,ret)},
      peg$c96 = "{",
